 ...
 */
@ThreadSafe
public class IngresConnector extends RelationalBaseSourceConnector {

    private static final Logger LOGGER = LoggerFactory.getLogger(IngresConnector.class);
    ...
    public Class<? extends Task> taskClass() {
        return IngresConnectorTask.class;
    }
    ...
    public ConfigDef config() {
        return IngresConnectorConfig.configDef();
    }
    ...
    protected void validateConnection(Map<String, ConfigValue> configValues, Configuration config) {
        ...
        IngresConnectorConfig connectorConfig = new IngresConnectorConfig(config);
        try (IngresConnection connection = new IngresConnection(connectorConfig.getJdbcConfig())) {
            try {
                connection.connect();
                connection.execute("SELECT dbmsinfo('database')");
    ...
    protected Map<String, ConfigValue> validateAllFields(Configuration config) {
        return config.validate(IngresConnectorConfig.ALL_FIELDS);
    }
