...
/**
 * The list of configuration options for Ingres connector
 *
 * @author Laoflch Luo, Lars M Johansson
 */
public class IngresConnectorConfig extends HistorizedRelationalDatabaseConnectorConfig {

    protected static final String CDC_DATABASE = "imadb";
    ...
    public IngresConnectorConfig(Configuration config) {
        super(
