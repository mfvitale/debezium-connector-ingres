...
public class IngresEventMetadataProvider implements EventMetadataProvider {
    ...
    public Map<String, String> getEventSourcePosition(DataCollectionId source, OffsetContext offset, Object key, Struct value) {
        ...
        return Collect.hashMapOf(
                SourceInfo.COMMIT_HEADER, sourceInfo.getString(SourceInfo.COMMIT_HEADER),
                SourceInfo.CHANGE_HEADER, sourceInfo.getString(SourceInfo.CHANGE_HEADER),
                SourceInfo.BEGIN_HEADER, sourceInfo.getString(SourceInfo.BEGIN_HEADER));
    }
