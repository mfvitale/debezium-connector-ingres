...
/**
 * Conversion of Ingres specific datatypes.
 *
 * @author Xiaolin Zhang, Laoflch Luo, Lars M Johansson
 *
 */
public class IngresValueConverters extends JdbcValueConverters {
     ...
     */
    public IngresValueConverters(DecimalMode decimalMode, TemporalPrecisionMode temporalPrecisionMode, BinaryHandlingMode binaryHandlingMode) {
