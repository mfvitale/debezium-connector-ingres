...
/**
 * CloudEvents maker for records produced by the Ingres connector.
 *
...
public class IngresCloudEventsMaker extends CloudEventsMaker {
    ...
    public IngresCloudEventsMaker(RecordAndMetadata recordAndMetadata, SerializerType contentType, String dataSchemaUriBase, String cloudEventsSchemaName) {
