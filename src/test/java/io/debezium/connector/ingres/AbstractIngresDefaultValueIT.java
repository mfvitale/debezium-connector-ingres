 ...
 */
public abstract class AbstractIngresDefaultValueIT extends AbstractAsyncEngineConnectorTest {
    ...
    protected abstract void performSchemaChange(Configuration config, IngresConnection connection, String alterStatement) throws Exception;
    ...
    private void testDefaultValuesCreateTableAndSnapshot(List<ColumnDefinition> columnDefinitions) throws Exception {
        ...
        config = TestHelper.defaultConfig()
                .with(IngresConnectorConfig.TABLE_INCLUDE_LIST, TestHelper.TEST_SCHEMA + ".dv_test")
                .with(IngresConnectorConfig.TIME_PRECISION_MODE, TemporalPrecisionMode.ADAPTIVE_TIME_MICROSECONDS)
                .build();
        ...
        List<SourceRecord> tableRecords = records.recordsForTopic(TestHelper.TEST_SCHEMA + ".dv_test");
        ...
        tableRecords = records.recordsForTopic(TestHelper.TEST_SCHEMA + ".dv_test");
        assertThat(tableRecords).hasSize(1);
        assertNoRecordsToConsume();
