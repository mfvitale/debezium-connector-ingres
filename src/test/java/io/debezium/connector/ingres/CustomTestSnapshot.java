...
import io.debezium.connector.ingres.snapshot.query.SelectAllSnapshotQuery;
...
public class CustomTestSnapshot extends SelectAllSnapshotQuery implements Snapshotter, BeanRegistryAware {
    ...
    public void injectBeanRegistry(BeanRegistry beanRegistry) {
        ...
        Offsets<IngresPartition, IngresOffsetContext> ingresOffsets = beanRegistry.lookupByName(StandardBeanNames.OFFSETS, Offsets.class);
        hasState = ingresOffsets.getTheOnlyOffset() != null;
    }
