...
public class IngresConnectorTest {
    ...
    protected static void assertConfigDefIsValid(Connector connector, io.debezium.config.Field.Set fields) {
        ...
        fields.forEach(expected -> {
            ...
            if (expected.equals(IngresConnectorConfig.SCHEMA_HISTORY)) {
            ...
            assertThat(key.orderInGroup).isPositive();
    ...
    public void shouldReturnConfigurationDefinition() {
        assertConfigDefIsValid(new IngresConnector(), IngresConnectorConfig.ALL_FIELDS);
    }
